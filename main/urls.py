...
from main.views import show_main, add_product, show_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, edit_product_ajax, delete_product, add_product_entry_ajax, login_user_ajax, register_user_ajax
